...
// Id doesn't exist
func GetAuthorById(id int) (v *Author, err error) {
	o := orm.NewOrm()
	v = &Author{Id: id}
...
// no records exist
func GetAllAuthor(query map[string]string, fields []string, sortby []string, order []string,
...
func UpdateAuthorById(m *Author) (err error) {
	o := orm.NewOrm()
	v := Author{Id: m.Id}
...
func DeleteAuthor(id int) (err error) {
	o := orm.NewOrm()
	v := Author{Id: id}
	// ascertain id exists in the database
	if err = o.Read(&v); err == nil {
