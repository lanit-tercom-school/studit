...
// UserCourseController operations for UserCourse
type UserCourseController struct {
	beego.Controller
}

// URLMapping ...
func (c *UserCourseController) URLMapping() {
...
// Post ...
// @Title Post
// @Description create UserCourse
// @Param	body		body 	models.UserCourse	true		"body for UserCourse content"
// @Success 201 {int} models.UserCourse
// @Failure 403 body is empty
// @router / [post]
func (c *UserCourseController) Post() {
...
// GetOne ...
// @Title Get One
// @Description get UserCourse by id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.UserCourse
// @Failure 403 :id is empty
// @router /:id [get]
func (c *UserCourseController) GetOne() {
...
// @Failure 403
// @router / [get]
func (c *UserCourseController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
...
// Put ...
// @Title Put
// @Description update the UserCourse
// @Param	id		path 	string	true		"The id you want to update"
// @Param	body		body 	models.UserCourse	true		"body for UserCourse content"
// @Success 200 {object} models.UserCourse
// @Failure 403 :id is not int
// @router /:id [put]
func (c *UserCourseController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
...
// Delete ...
// @Title Delete
// @Description delete the UserCourse
// @Param	id		path 	string	true		"The id you want to delete"
// @Success 200 {string} delete success!
// @Failure 403 id is empty
// @router /:id [delete]
func (c *UserCourseController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
